...
<nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <a class="" href="task-info.php"><span style=>
        <img src="assets/img/QLogo.png"  style="width: -webkit-fill-available; height:65px"></span></a>
    </div>
...
<nav class="navbar navbar-default custom-nav">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       ...
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="assets/img/avatar.png" width="50px">
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li class="bg-primary user"><a href="#"> <h4>Romit Patel</h4></a></li>
